...
def mavlinkrouter():
    os.system('mavproxy.py --master=/dev/ttyACM0,57600 --out=udpbcast:169.254.251.184:14550') #Yer Istasyonu IP
        ...
        if time.time() - sure > 0.1:
            ...
            if mod == "kamikaze":
                ...
                if pwm_verileri != None and pwm_verileri['rakip']:
                    x, y, width, height = pwm_verileri['x'], pwm_verileri['y'], pwm_verileri['width'], pwm_verileri['height']
