...
class Detection:
    ...
    def model_predict(self, frame):
        ...
        results = self.model.track(source=frame, conf=0.70, iou=0.5, show=False, tracker="botsort.yaml", verbose=False)
        ...
        if results:
            ...
            #! bir frame üzerinde doğruluk değeri en yüksek olan rakibe kilitlenme
            if boxes: 
                ...
                if x1 > target_area_x1 and x2 < target_area_x2 and y1 > target_area_y1  and  y2 < target_area_y2:
                    locked_or_not = True                    
    ...
    def coordinates_to_pwm(self, x_center, y_center):
        ...
        #! buradan sonra pwm verileri ile regresyon analizi yapıp rakip ihanın bir sonraki gideceği yeri tespit etme kısmı gelecek
...
detection = Detection("C:\\Users\\asus\\AlganYazilim\\Calismalar\\Behçet\\V5_best.pt")
detection()
