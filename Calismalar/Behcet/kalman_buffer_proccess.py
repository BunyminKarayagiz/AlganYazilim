    ...
    def model_predict(self, frame,frame_id):
        ...
        if results:
            ...
            for box in boxes:
                ...
                cv2.circle(frame, (predicted[0], predicted[1]), 5, (50, 10, 200), 4)
                cv2.line(frame, (x_center, y_center), (predicted[0], predicted[1]), (255, 255, 255), 1)
                cv2.imshow("kalman deneme", frame)
                ...
                tahmin = {
                    "x_tahmin" : predicted[0],
                    "y_tahmin" : predicted[1]
                }
