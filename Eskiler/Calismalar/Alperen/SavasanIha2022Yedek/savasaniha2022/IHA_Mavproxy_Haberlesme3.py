...
while True:
    try:
        ...
        if time.time() - sure > 0.1:
            ...
            # AUTO
            if iha.ch6 > 1600 and iha.ch8 > 1600:  # Servo6: High, ch8: High
                mod = 'AUTO'
                mesaj['iha_otonom'] = 1
            ...
            # FBWA
            if (iha.ch6 > 1400 and iha.ch6 < 1600) and iha.ch8 > 1600:  # Servo6: Mid, ch8: High
                mod = 'FBWA'
                mesaj['iha_otonom'] = 0
            ...
            # RTL
            if iha.ch6 < 1400 and iha.ch8 > 1600:  # Servo6: Low, ch8: High
                mod = "RTL"
                mesaj['iha_otonom'] = 1
            ...
            # KİLİTLENME
            if iha.ch6 > 1600 and (iha.ch8 > 1400 and iha.ch8 < 1600):  # Servo6: High, ch8: Mid
                mod = "kilitlenme"
                mesaj['iha_otonom'] = 1
...
#                    iha.set_rc_channel(3,1500)
            ...
            # KAMİKAZE
            if (iha.ch6 > 1400 and iha.ch6 < 1600) and (iha.ch8 > 1400 and iha.ch8 < 1600):  # Servo6: Mid, ch8: Mid
                mod = "kamikaze"
                mesaj['iha_otonom'] = 1
                try:
