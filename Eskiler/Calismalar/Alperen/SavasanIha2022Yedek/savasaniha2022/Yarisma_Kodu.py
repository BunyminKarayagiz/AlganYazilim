    ...
    try:
        ...
        if time.time() - sure > 0.1:
            ...
            if iha.ch6 > 1600 and (iha.ch8 > 1400 and iha.ch8 < 1600):  # ch6: High, ch8: Mid
                mod = "kilitlenme"
                mesaj['iha_otonom'] = 1
                time_difference_value_FBWA = 0.2
                print(iha.get_ap_mode())
                if iha.pos_alt_rel <= -5:
                    if iha.get_ap_mode() != 'RTL':
                        iha.set_ap_mode('RTL')
                else:
            ...
            if iha.ch6 > 1600 and iha.ch8 < 1400 :  # ch6: High, ch8: LOW
                ...
                try:
                    ...
                    if not qr_gidiyor and not kalkista and qr_mesafe > 0.125:  # and iha.pos_alt_rel > 100:
                        print('qr_gidiyor')
                    ...
                    if qr_mesafe < 0.14 and qr_gidiyor:  # 150 metre
                        if iha.get_ap_mode() != "FBWA":
                            iha.set_ap_mode("FBWA")

                        iha.set_rc_channel(1, 1500)  # Channel 1 is for Roll Input,
                        iha.set_rc_channel(2, 1900)  # Channel 2 is for Pitch Input,
                        iha.set_rc_channel(3, 1100)  # Channel 3 is for Throttle Input,

                    if iha.pos_alt_rel < 60:
                    ...
                    if kalkista and iha.pos_alt_rel < 100:
                        ...
                        iha.set_rc_channel(1, 1500)
                        iha.set_rc_channel(2, 1100)
                        iha.set_rc_channel(3, 1700)

                    if kalkista and iha.pos_alt_rel > 40:
