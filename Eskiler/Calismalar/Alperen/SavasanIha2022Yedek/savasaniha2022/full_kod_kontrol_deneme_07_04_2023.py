        ...
        if time.time() - sure > 0.1:
            ...
            if iha.ch6 > 1600 and (iha.ch8 > 1400 and iha.ch8 < 1600):  # ch6: High, ch8: Mid
                ...
                if pwm_verileri != None and pwm_verileri['rakip']:
                    reference_instant_time = time.time()
                    time_difference = reference_instant_time - sayac
                    ...
                    if iha.get_ap_mode() != "FBWA" and loiter == 0 and time_difference > time_difference_value:
                        iha.set_ap_mode("FBWA")
            ...
            # KAMİKAZE
            if (iha.ch6 > 1400 and iha.ch6 < 1600) and (iha.ch8 > 1400 and iha.ch8 < 1600):  # ch6: Mid, ch8: Mid
                mod = "kamikaze"
                mesaj['iha_otonom'] = 1
                try:
