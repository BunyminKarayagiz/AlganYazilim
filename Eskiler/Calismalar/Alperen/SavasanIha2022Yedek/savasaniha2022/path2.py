...
"""
from dronekit import Vehicle, connect, VehicleMode, LocationGlobalRelative, Command, Battery, LocationGlobal, Attitude, logging 
import dronekit
...
#         self.master = self.vehicle.alganrc
    ...
    def mesajlar(self):
        self.mesaj = {
            "takim_numarasi": 4,
            "IHA_enlem": self.pos_lat,
            "IHA_boylam": self.pos_lon,
            "IHA_irtifa": self.pos_alt_rel,
            "IHA_dikilme": self.att_pitch_deg,
            "IHA_yonelme": self.att_heading_deg,
            "IHA_yatis": self.att_roll_deg,
            "IHA_hiz": self.groundspeed,
