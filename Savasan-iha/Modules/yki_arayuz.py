...
class MAIN_GUI_FRAME(customtkinter.CTkFrame):
    ...
    #? LAYER-3
        ...
        self.HSS_PLANNER=customtkinter.CTkButton(master=self.left_main_frame.tab("CONTROL"),text="HSS-GET",command=Yer_istasyonu_obj.HSS_MPLANNER)
        self.HSS_PLANNER.grid(row=1,column=0,padx=10,pady=10,sticky="nwe")

        self.QrUPDATE_BUTTON=customtkinter.CTkButton(master=self.left_main_frame.tab("CONTROL"),text="QR UPDATE",command=Yer_istasyonu_obj.QR_UPDATE)
        self.QrUPDATE_BUTTON.grid(row=2,column=0,padx=10,pady=10,sticky="nwe")
        ...
        self.HSS_BUTTON.grid(row=1,column=1,padx=10,pady=10,sticky="nwe")
        
        self.LOCK_TEST_BUTTON=customtkinter.CTkButton(master=self.left_main_frame.tab("CONTROL"),text="KILITLENME-TEST",command=Yer_istasyonu_obj.KILITLENME_TEST)
        self.LOCK_TEST_BUTTON.grid(row=2,column=1,padx=10,pady=10,sticky="nwe")
        ...
        self.QRTEST_BUTTON.grid(row=3,column=1,padx=10,pady=10,sticky="nwe")
