...
def TCP_connection_handler(function):
...
if __name__ == '__main__':
    ...
    Tcp_thread = threading.Thread(target=TCP_connection_handler,args=(yer_istasyonu.ana_sunucu.sunucuya_postala,))
    Udp_thread = threading.Thread(target=UDP_connection_handler)
